/*
--------------------------------------------------------------------------------
 Description  : Stored procedure to load raw data from CSV files into the
                Bronze Layer tables using BULK INSERT. Includes detailed 
                logging of loading durations and error handling.
 ...
 Notes        : Ensure the file paths are accessible by SQL Server and the
                Bronze schema and tables are already created.
--------------------------------------------------------------------------------
*/
